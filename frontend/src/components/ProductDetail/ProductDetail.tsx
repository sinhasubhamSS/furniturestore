    ...
    <div className="max-w-[1440px] mx-auto px-2 md:px-4 py-6">
      <div className="flex flex-col lg:flex-row gap-3 lg:gap-4">
        ...
        <div className="w-full lg:w-1/2 mt-4 lg:mt-0">
          {" "}
          {/* Add margin-top on mobile, remove on desktop */}
